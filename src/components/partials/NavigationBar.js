    ...
    render() {
        return (<nav className={style.navigationBar}>
          ...
          <ul className={style.links}>
            <li className={style.link}><NavLink to='/' exact activeClassName={style.activeLink}>Home</NavLink></li>
            <li className={style.link}><NavLink to='/commits' activeClassName={style.activeLink}>Commits</NavLink></li>
          </ul>
        </nav>)
    }
}
